...
class Company extends \Faker\Provider\Company
{
    ...
    protected static $companyPrefix = array(
        'شرکت', 'موسسه', 'سازمان', 'بنیاد','دانش بنیان'
    );

    protected static $companyField = array(
        'فناوری اطلاعات', 'راه و ساختمان', 'توسعه معادن', 'استخراج و اکتشاف',
        'پست ایران','سازمان انرژی اتمی','ایرانسل','همراه اول','گل گهر','تراکتور سازی',
        'بازیافت','تعزیرات', 'راه آهن','سرمایه گذاری', 'نساجی', 'کاریابی','تجهیزات اداری',
        'تولیدی', 'فولاد'
    );
